...
describe('magento2/core/widget/encode_conditions', () => {
    ...
    it('nested object', async () => {
        deepStrictEqual(encode_conditions('^[`a`:^[`b`:`c`^]^]'), {
            a: {
                b: 'c'
            }
        });
    ...
    it('convert to path', async () => {
        deepStrictEqual(encode_conditions('^[`a`:^[`b`:`c||d||e`^]^]'), {
            a: {
                b: 'c/d/e'
            }
        });
    ...
    it('object in string', async () => {
        deepStrictEqual(encode_conditions('^[`a`:^[`b`:`^[^]`^]^]'), {
            a: {
                b: '{}'
            }
        });
    ...
    it('sample 3', async () => {
        deepStrictEqual(encode_conditions('^[`1`:^[`type`:`Magento||CatalogWidget||Model||Rule||Condition||Combine`,`aggregator`:`all`,`value`:`1`,`new_child`:``^]^]'), {
            1: {
                aggregator: 'all',
                new_child: '',
                type: 'Magento/CatalogWidget/Model/Rule/Condition/Combine',
